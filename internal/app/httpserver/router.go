...
import (
	...
	webhookhttp "github.com/dujiao-next/internal/modules/telegram/webhook/transport/http"
...
func SetupRouter(cfg *config.Config, c *container.Container) *gin.Engine {
	...
	userResellerPurchaseHandler := resellerHandlers.UserPurchase
	...
	registerStorefrontRoutes(apiV1, cfg, c, publicContentHandler, publicCatalogHandler, publicCategoryHandler, userResellerHandler, userResellerProductSettingHandler, userResellerFinanceHandler, userResellerOrderHandler, userResellerPurchaseHandler, userApiCredentialHandler, userAuditLogHandler, userGiftCardHandler, publicMemberLevelHandler, userProfileHandler, userEmailHandler, userPasswordHandler, userVerifyHandler, userTelegramOIDCHandler, userTelegramHandler, userGoogleHandler, userLoginHandler, user2FAHandler, publicConfigHandler, userCartHandler, userOrderHandler, guestOrderHandler, orderPreviewHandler, orderCreateHandler, paymentLatestHandler, paymentWriteHandler, userWalletHandler, redisClient, loginRule, guestReadRule, guestWriteRule)
	...
	webhookhttp.RegisterWebhookRoutes(apiV1, telegramWebhookUpdateHandler)
